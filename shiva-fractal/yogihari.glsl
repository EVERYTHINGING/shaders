...
//*********** UPDATE PHOTO (in browser console):
//gShaderToy.SetTexture(0, {mSrc:'https://i.ibb.co/XpsWhm7/sunsalutation.png', mType:'texture', mID:1, mSampler:{ filter: 'mipmap', wrap: 'repeat', vflip:'true', srgb:'false', internal:'byte' }});
